...
export const newproductClient = {
  ...crudFactory<Product, QueryOptions, CreateProduct>(
    API_ENDPOINTS.PRODUCTS
  ),
  
  // paginated: ({ type, name, categories,shop_id,...params }: Partial<ProductQueryOptions>) => {
  //   return HttpClient.get<ProductPaginator>(API_ENDPOINTS.PRODUCTS, {
  //     searchJoin: 'and',
  //     ...params,
  //     search: HttpClient.formatSearchParams({ type,name,categories,shop_id}),
  //   });
  // },
